...
PROKKA_PREFIX="${ORGANISM}"
PROKKA_LOCUS_TAG="EFM745"
PROKKA_GENUS="Enterococcus"
PROKKA_SPECIES="faecium"
PROKKA_STRAIN="E745"
PROKKA_GFF="${PROKKA_DIR}/${PROKKA_PREFIX}.gff"
PROKKA_FAA="${PROKKA_DIR}/${PROKKA_PREFIX}.faa"
PROKKA_FFN="${PROKKA_DIR}/${PROKKA_PREFIX}.ffn"
