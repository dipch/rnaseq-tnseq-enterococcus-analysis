...
#SBATCH --output=/home/dich3309/rnaseq-tnseq-enterococcus-analysis/log/05c_align_flye_pacbio_with_illumina.%j.out
...
bwa mem -t 2 "${FLYE_PACBIO_FA}" "${ILLUMINA_R1}" "${ILLUMINA_R2}" \
    | samtools sort -@ 2 -o "${FLYE_PACBIO_SORTED_BAM}"
